                                ...
                                <div class="tab-pane <?= ($active_tab == 1) ? ' active show' : '' ?>" id="newRabid">
                                    <div class="table">
                                        ...
                                        <form method="post" action="./dashboardRabidCases.php?active-tab=1">
                                            ...
                                            <button type="submit" name="accept" class="btn btn-success" onclick="document.getElementById(\'notifMessage\').value=\'Suspected Rabid Case has been accepted.\'">Accept</button>
                                            <button type="submit" name="reject" class="btn btn-danger" onclick="document.getElementById(\'notifMessage\').value=\'Suspected Rabid Case has been rejected.\'">Reject</button>                                                                       
                                        </form>
                                        </td>';
                                                                echo '</tr>';
                                                            }
                                            ...
                                            <div class="d-flex justify-content-center mt-4">
                                                <ul class="pagination">
                                                    <?php for ($n = 1; $n <= $total_pages_newRabid; $n++) { ?>
                                                        <li class="page-item <?= ($n == $page_newRabid) ? 'active' : '' ?>">
                                                            <a class="page-link" href="./dashboardRabidCases.php?active-tab=1&page_new=<?= $n ?>"><?= $n ?></a>
                                                        </li>
                                                    <?php } ?>
                                                </ul>
                                            </div>
                                ...
                                <div class="tab-pane <?= ($active_tab == 2) ? ' active show' : '' ?>" id="validRabid">
                                    <div class="table">
                                        ...
                                        <form method="post" action="process_viewSusLocation.php">
                                            ...
                                            <div class="d-flex justify-content-center mt-4">
                                                <ul class="pagination">
                                                    <?php for ($v = 1; $v <= $total_pages_validRabid; $v++) { ?>
                                                        <li class="page-item <?= ($v == $page_validRabid) ? 'active' : '' ?>">
                                                            <a class="page-link" href="./dashboardRabidCases.php?active-tab=2&page_valid=<?= $v ?>"><?= $v ?></a>
                                                        </li>
                                                    <?php } ?>
                                                </ul>
                                            </div>
                                ...
                                <div class="tab-pane <?= ($active_tab == 3) ? ' active show' : '' ?>" id="rejectedRabid">
                                    <div class="table">
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex justify-content-center mt-4">
                                                <ul class="pagination">
                                                    <?php for ($r = 1; $r <= $total_pages_rejectedRabid; $r++) { ?>
                                                        <li class="page-item <?= ($r == $page_rejectedRabid) ? 'active' : '' ?>">
                                                            <a class="page-link" href="./dashboardRabidCases.php?active-tab=3&page_rej=<?= $r ?>"><?= $r ?></a>
                                                        </li>
                                                    <?php } ?>
                                                </ul>
                                            </div>
