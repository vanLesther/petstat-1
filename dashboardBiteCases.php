                ...
                <main class="row overflow-auto">
                    <div class="col-md-8 p-1 mt-2 my-auto mx-auto">
                        <div class="container mt-4">
                            ...
                            <ul class="nav nav-tabs">
                                <li class="nav-item">
                                    <a class="nav-link<?= ($active_tab == 1) ? ' active' : '' ?>" href="./dashboardBiteCases.php?active-tab=1&page_new=1#newBiteCase" data-bs-toggle="tab">New Bite Cases</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link<?= ($active_tab == 2) ? ' active' : '' ?>" href="./dashboardBiteCases.php?active-tab=2&page_valid=1#validBiteCase" data-bs-toggle="tab">Valid Bite Cases</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link<?= ($active_tab == 3) ? ' active' : '' ?>" href="./dashboardBiteCases.php?active-tab=3&page_rej=1#rejectedBiteCase" data-bs-toggle="tab">Rejected Bite Cases</a>
                                </li>
                            </ul>
                                ...
                                <div class="tab-pane <?= ($active_tab == 1) ? ' active show' : '' ?>" id="newBiteCase">
                                    <div class="table">
                                        ...
                                        <form method="post" action="./dashboardBiteCases.php?active-tab=1">
                                            ...
                                            <button type="submit" name="accept" class="btn btn-success" onclick="document.getElementById(\'notifMessage\').value=\'Bite Case report has been accepted.\'">Accept</button>
                                            <button type="submit" name="reject" class="btn btn-danger" onclick="document.getElementById(\'notifMessage\').value=\'Bite Case report has been rejected.\'">Reject</button>                                                                       
                                        </form>
                                    </td>';
                                                                echo '</tr>';
                                                            }
                                            ...
                                            <div class="d-flex justify-content-center mt-4">
                                                <ul class="pagination">
                                                    <?php for ($d = 1; $d <= $total_pages_bite; $d++) { ?>
                                                        <li class="page-item <?= ($d == $page_bite) ? 'active' : '' ?>">
                                                            <a class="page-link" href="./dashboardBiteCases.php?active-tab=1&page_new=<?= $d ?>"><?= $d ?></a>
                                                        </li>
                                                    <?php } ?>
                                                </ul>
                                            </div>
                                ...
                                <div class="tab-pane <?= ($active_tab == 2) ? ' active show' : '' ?>" id="validBiteCase">
                                    <div class="table">
                                        ...
                                        <button type="submit" name="accept" class="btn btn-success">View Location</button>
                                            ...
                                            <div class="d-flex justify-content-center mt-4">
                                                <ul class="pagination">
                                                    <?php for ($d = 1; $d <= $total_pages_valid_bite; $d++) { ?>
                                                        <li class="page-item <?= ($d == $page_valid_bite) ? 'active' : '' ?>">
                                                            <a class="page-link" href="./dashboardBiteCases.php?active-tab=2&page_valid=<?= $d ?>"><?= $d ?></a>
                                                        </li>
                                                    <?php } ?>
                                                </ul>
                                            </div>
...
<<<<<<< HEAD
                                            ...
                                            <div class="d-flex justify-content-center mt-4">
                                                <ul class="pagination">
                                                    <?php for ($d = 1; $d <= $total_pages_rejected_bite; $d++) { ?>
                                                        <li class="page-item <?= ($d == $page_rejected_bite) ? 'active' : '' ?>">
                                                            <a class="page-link" href="./dashboardBiteCases.php?active-tab=3&page_rej=<?= $d ?>"><?= $d ?></a>
                                                        </li>
                                                    <?php } ?>
                                                </ul>
                                            </div>
