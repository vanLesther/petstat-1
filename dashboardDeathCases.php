                                ...
                                <div class="tab-pane <?= ($active_tab == 1) ? ' active show' : '' ?>" id="newDeathCase">
                                    <div class="table">
                                        ...
                                        <form method="post" action="./dashboardDeathCases.php?active-tab=1">
                                            ...
                                            <button type="submit" name="accept" class="btn btn-success" onclick="document.getElementById(\'notifMessage\').value=\'Death Case report has been accepted.\'">Accept</button>
                                            <button type="submit" name="reject" class="btn btn-danger" onclick="document.getElementById(\'notifMessage\').value=\'Death Case report has been rejected.\'">Reject</button>                                                                       
                                        </form>
                                    </td>';
                                                                echo '</tr>';
                                                            }
                                ...
                                <div class="tab-pane <?= ($active_tab == 2) ? ' active show' : '' ?>" id="validDeathCase">
                                    <div class="table">
                                        ...
                                        <form method="post" action="process_rabies.php">
                                            ...
                                            <input type="hidden" name="notifDate" id="notifDate" value="' . date('Y-m-d H:i:s') . '">
                                            <input type="hidden" name="notifMessage" id="notifMessage" value="A death report has been determined as a bite case.">
