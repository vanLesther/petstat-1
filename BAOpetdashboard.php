...
<body>
    ...
    <main class="row overflow-auto">
        <div class="col-md-8 p-1 mt-2 my-auto mx-auto">
            <div class="container mt-2 d-flex flex-column align-items-start">
                        ...
                        <div class="container mt-4">
                            ...
                            <form method="POST" action="" id="petform" name="petform">
                                <ul class="nav nav-tabs">
                                    <li class="nav-item">
                                        <a class="nav-link<?= ($active_tab == 1) ? ' active' : '' ?>" href="./BAOpetdashboard.php?active-tab=1&page_add=1#addPets">My Pets</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link<?= ($active_tab == 2) ? ' active' : '' ?>" href="./BAOpetdashboard.php?active-tab=2&page_bite=1#bitePets">Report Bite Cases</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link<?= ($active_tab == 3) ? ' active' : '' ?>" href="./BAOpetdashboard.php?active-tab=3&page_death=1#deathPets">Report Death Cases</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link<?= ($active_tab == 4) ? ' active' : '' ?>" href="./BAOpetdashboard.php?active-tab=4&page_suspected=1#suspectedPets">Report Suspected Cases</a>
                                    </li>
                                </ul>
                            </form>
                                    ...
                                    <div class="table">
                                        <div class="card-body">
                                            <form method="POST" action="addPetBao.php">
                                                ...
                                                <button type="submit" class="btn btn-primary"><strong>Add Pet</strong></button>
                                            </form>
                                                                        ...
                                                                        <div class="modal-content">
                                                                            ...
                                                                            <div class="modal-body">
                                                                                ...
                                                                                <form method="post" action="process_updateVac.php">
                                                                                    <input type="hidden" name="statusVac" value="0">
                                                ...
                                                <ul class="pagination">
                                                    <?php for ($i = 1; $i <= $total_pages_add; $i++) { ?>
                                                        <li class="page-item <?= ($i == $page_add) ? 'active' : '' ?>">
                                                            <a class="page-link" href="./BAOpetdashboard.php?active-tab=1&page_add=<?= $i ?>"><?= $i ?></a>
                                                        </li>
                                                    <?php } ?>
                                                </ul>
                                            </div>
                                ...
                                <div class="table">
                                    <div class="card-body">
                                        <form method="POST" action="addBiteCase.php">
                                                ...
                                                <input type="hidden" name="residentID" value="<?php echo $residentID; ?>">
                                                <input type="hidden" name="userType" id="userType" value="<?php echo $userType; ?>">
                                                <button type="submit" class="btn btn-primary"><strong>Report Bite Case</strong></button>
                                            </form>
                                            <form method="post" action="">
                                            <div class="input-group mb-3">
                                                <input type="text" class="form-control" id="biteSearch" name="biteSearch" placeholder="Search..." value="<?php echo isset($_POST['biteSearch']) ? $_POST['biteSearch'] : ''; ?>">
                                ...
                                <div class="table">
                                    <div class="card-body">
                                        <form method="POST" action="reportRabidBao.php">
                                            ...
                                            <input type="hidden" name="residentID" value="<?php echo $residentID; ?>">
                                            <input type="hidden" name="userType" id="userType" value="<?php echo $userType; ?>">
                                            <button type="submit" class="btn btn-primary"><Strong>Report Suspected Case</Strong></button>
                                        </form>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <?php } else { ?>
                                                                        <form method="post" action="process_cancel.php">
                                                                            ...
                                                                            <button type="submit" name="cancel_suspected" class="btn btn-danger">Cancel</button>
                                                                        </form>
                                                                    <?php } ?>
                                                                </td>
                                                            </tr>
