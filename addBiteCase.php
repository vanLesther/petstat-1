                ...
                <main class="row overflow-auto">
                    <div class="col-md-8 p-1 mt-2 my-auto mx-auto">
                        ...
                        <div class="col-md-auto">
                            <a href="./BAOpetdashboard.php?active-tab=2" class="btn btn-primary rounded-circle p-2">
                                                ...
                                                if ($searchTerm === '%%') {
                                                    ...
                                                    if ($result->num_rows > 0) {
                                                        ...
                                                        for ($b = 1; $b <= $total_pages; $b++) {
                                                            ...
                                                            echo '<a class="page-link" href="addBiteCase.php?page=' . $b . '">' . $b . '</a>';
                                                            echo '</li>';
                                                        }
                                                        echo '</div>';
                                                        echo '</div>';
                                ...
                                <div class="tab-pane fade" id="Unknown">
                                    <div class="mb-3">
                                        ...
                                        <form method="POST" action="process_Unknown.php" id="addUnknown">
                                            ...
                                            <input type="hidden" name="latitude" id="latitude">
                                            <input type="hidden" name="longitude" id="longitude">
                                            <input type="submit" class="btn btn-primary mt-2" value="Report Case" onclick="getLocationAndSubmit()" form="addUnknown">
                                        </form>
