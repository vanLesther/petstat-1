                ...
                <main class="row overflow-auto">
                    <div class="col-md-8 p-1 mt-2 my-auto mx-auto">
                        ...
                        <div class="col-md-auto">
                            <a href="./BAOpetdashboard.php?active-tab=4" class="btn btn-primary rounded-circle p-2">
                                                ...
                                                if ($searchTerm === '%%') {
                                                    ...
                                                    if ($result->num_rows > 0) {
                                                        ...
                                                        for ($b = 1; $b <= $total_pages; $b++) {
                                                            ...
                                                            echo '<a class="page-link" href="reportRabidBao.php?page=' . $b . '">' . $b . '</a>';
                                                            echo '</li>';
                                                        }
                                                        echo '</div>';
                                                        echo '</div>';
                                            ...
                                            <div class="modal-body">
                                                <form method="POST" action="process_reportRabid.php" id="reportBiteCaseForm">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <input type="hidden" name="notifDate" id="notifDate" value="">
