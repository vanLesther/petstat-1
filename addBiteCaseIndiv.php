                                                ...
                                                if ($searchTerm === '%%') {
                                                    ...
                                                    if ($result->num_rows > 0) {
                                                        ...
                                                        for ($b = 1; $b <= $total_pages; $b++) {
                                                            ...
                                                            echo '<a class="page-link" href="addBiteCaseIndiv.php?page=' . $b . '">' . $b . '</a>';
                                                            echo '</li>';
                                                        }
                                                        echo '</div>';
                                                        echo '</div>';
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <div class="modal-body">
                            ...
                            <!-- Remove the hidden input field for petID -->
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="victimsNames[]" id="victimsName' + victimCounter + '" required>                    </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="descriptions[]" id="description' + victimCounter + '" required>
                                </div>
                        ...
                        <script>
                            ...
                            '<div class="mb-3">' +
                            '<label for="victimsName' + victimCounter + '" class="form-label">Victim ' + victimCounter + ' Name:</label>' +
                            '<div class="input-group">' +
                            '<input type="text" class="form-control" name="victimsNames[]" id="victimsName' + victimCounter + '" required>' +
                            '</div>' +
                            '</div>' +
                            '<div class="mb-3">' +
                            '<label for="date' + victimCounter + '" class="form-label">Date & Time of Bite:</label>' +
                            '<input type="datetime-local" class="form-control" name="dates[]" id="date' + victimCounter + '" required>' +
                            '</div>' +
                            '<div class="mb-3">' +
                            '<label for="bpartBitten' + victimCounter + '" class="form-label">Body Part Bitten:</label>' +
                            '<select class="form-control" name="bpartsBitten[]" id="bpartBitten' + victimCounter + '" required>' +
                            '<option value="">Select Body Part</option>' +
                            '<option value="0">Head and Neck Area</option>' +
                            '<option value="1">Thorax Area</option>' +
                            ...
                            '</div>' +
                            '<div class="mb-3">' +
                            '<label for="description' + victimCounter + '" class="form-label">Description:</label>' +
                            '<input type="text" class="form-control" name="descriptions[]" id="description' + victimCounter + '" required>' +
                            '</div>' +
        ...
        <div class="tab-pane fade" id="Unknown">
            <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <label for="description" class="form-label">Description:</label>
                        <textarea type="text" class="form-control" name="descriptions[]" id="description' + victimCounter + '" required></textarea>
                    </div>
                    ...
                    <input type="hidden" name="latitude" id="latitude">
                    <input type="hidden" name="longitude" id="longitude">
                    <input type="submit" class="btn btn-primary" value="Report Bite Case" onclick="getLocationAndSubmit()" form="addUnknown">
                </form>
